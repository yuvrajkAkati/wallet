                    ...
                    <div className="flex justify-between pl-4 pb-5">                       
                        ...
                        <div className="pl-2">
                         ...
                         <div className="justify-center place-items-center flex pr-4 ">
                                <div className="pr-4"><button className="pl" onClick={onClickDeleteIndividual1}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="red" className="size-5">
